...
export const GET_USER_DOCUMENTS_LIST_KEY = 'GET_USER_DOCUMENTS_LIST_KEY';
export const SAMPLE_CHAT_ID = '123456789';
export const SAMPLE_VOICE_ID = '1chWRM70ePjamezxPfiV';
